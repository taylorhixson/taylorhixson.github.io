...
<iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/1674401/sp/167440100/embedIframeJs/uiconf_id/23435151/partner_id/1674401?iframeembed=true&playerId=kaltura_player&entry_id=1_edaysjs0&flashvars[streamerType]=auto&amp;flashvars[localizationCode]=en&amp;flashvars[leadWithHTML5]=true&amp;flashvars[sideBarContainer.plugin]=true&amp;flashvars[sideBarContainer.position]=left&amp;flashvars[sideBarContainer.clickToClose]=true&amp;flashvars[chapters.plugin]=true&amp;flashvars[chapters.layout]=vertical&amp;flashvars[chapters.thumbnailRotator]=false&amp;flashvars[streamSelector.plugin]=true&amp;flashvars[EmbedPlayer.SpinnerTarget]=videoHolder&amp;flashvars[dualScreen.plugin]=true&amp;flashvars[LeadWithHLSOnFlash]=true&amp;flashvars[Kaltura.addCrossoriginToIframe]=true&amp;&wid=1_qs8w6m8i" width="608" height="402" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" sandbox="allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Kaltura Player"></iframe>
...
3. In the top right of the repository, click **Fork**.
  ...
  ![Image is a screenshot of the top right of the repository in GitHub showing the Watch, Star, and Fork options with Fork outlined in red](https://github.com/taylorhixson/WF/blob/master/imagesDOC/fork.png?raw=true "Fork this repository")
...
5. In the **WF** repository, click **Clone or download**, and from that popup, choose **Open in Desktop**. Make sure the link shows your GitHub username **NOT** the workshop creator's username. The below screenshot shows the creator's because the screenshot was taken from her account.
  ...
  ![Image is a screenshot of the middle right of the repository options in GitHub showing the Create new file, Upload files, Find files, and Clone or download options with Clone or download outlined in red](https://github.com/taylorhixson/WF/blob/master/imagesDOC/clone.png?raw=true "Clone this repository")

  If the browser prompts you, choose **Open GitHub Desktop**.

  ![Image is a screenshot of a browser prompt asking "Open GitHub Desktop with options to cancel or open."](https://github.com/taylorhixson/WF/blob/master/imagesDOC/openDesktop.png?raw=true "Open GitHub Desktop")
...
1. Once the repository is cloned, click **Current Branch**, which is between Current Repository and Push origin. The current branch probably says master.
  ...
  ![Image is a screenshot showing the Current Branch button.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/currentBranch.png?raw=true "Current branch is master")

2. Click **New Branch**.

  ![Image is a screenshot highlighting the New Branch button.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/newBranch.png?raw=true "Create a new branch")
...
3. Name the new branch **gh-pages**. The branch **must** be named gh-pages. Naming a branch gh-pages tells GitHub that the branch should function as [GitHub Pages](https://help.github.com/en/articles/what-is-github-pages), GitHub's hosting services.
  ...
  ![Image is a screenshot highlighting the new branch name gh-pages.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/ghPages.png?raw=true "Create GitHub Pages")
...
5. Make sure the file type is **.qgz**.
    ...
    ![Image is a screenshot showing the location and file type for saving QGIS projects](https://github.com/taylorhixson/WF/blob/master/imagesDOC/qgisSave.png?raw=true "Save QGIS project")
...
2. Click **Plugins** from the top menu.
      ...
      ![Image is a screenshot highlighting the Plugins option in the top menu](https://github.com/taylorhixson/WF/blob/master/imagesDOC/plugins.png?raw=true "Click Plugins")

3. Click **Manage and Install Plugins...**.

      ![Image is a screenshot showing the manage and install plugins options](https://github.com/taylorhixson/WF/blob/master/imagesDOC/installPlugins.png?raw=true "Click manage and install plugins")
...
4. Make sure **All** is selected from the left side of the popup window, and in the search box, type **qgis2web**. **Note**: an internet connection is required to search for and install plugins this way.
      ...
      ![Image is a screenshot highlighting searching for plugins](https://github.com/taylorhixson/WF/blob/master/imagesDOC/qgis2web.png?raw=true "Click qgis2web")
...
6. Below the plugin description, click **Install plugin**.
      ...
      ![Image is a screenshot showing to click Install plugin in the bottom right](https://github.com/taylorhixson/WF/blob/master/imagesDOC/installPlugin.png?raw=true "Click Install plugin")

7. In the search results, make sure the box next to it is checked so that it appears.

      ![Image is a screenshot highlighting the box that needs to be checked to the left of the plugin name](https://github.com/taylorhixson/WF/blob/master/imagesDOC/checked.png?raw=true "Box is checked")
...
8. Search for **QuickMapServices**, and click **Install Plugin**. Make sure the box next to it is checked, too. For future reference, [open GIS Lab has a tutorial](https://opengislab.com/blog/2018/4/15/add-basemaps-in-qgis-30) and more information about configuring QuickMapServices and accessing more basemap options than the default.
      ...
      ![Image is a screenshot of the QuickMapServices plugin information window](https://github.com/taylorhixson/WF/blob/master/imagesDOC/qms.png?raw=true "QuickMapServices QGIS plugin")
...
9. From the **top menu**, click **Web**. Qgis2Web and QuickMapServices should both appear there. If not, quit QGIS and reopen the project. If it still does not appear, go back to the manage and install plugins window and check that these are listed in Installed Plugins. If the plugins are listed there, make sure the box to the left of the plugin is checked.
      ...
      ![Image is a screenshot of highlighting that the two plugins are available under Web](https://github.com/taylorhixson/WF/blob/master/imagesDOC/installed.png?raw=true "PLugins are installed")

### Adding tabular data to QGIS

1. From the top menu, click Layer>Add Layer>Add Delimted Text data.

      ![Image is a screenshot that shows Layer and add layer menus of QGIS with add delimited text data highlight](https://github.com/taylorhixson/WF/blob/master/imagesDOC/addCSV.png?raw=true "Add CSV")
...
4. Still in the Geometry Definition box, click the globe button to the far right of **Geometry CRS**.
    ...
    ![Image is a screenshot that shows an arrow pointing to the globe button](https://github.com/taylorhixson/WF/blob/master/imagesDOC/addCRS.png?raw=true "Define CRS")
...
8. The points should appear in the main workspace, and the CSV should appear in the Layers panel.
    ...
    ![Image is a screenshot that shows an arrow pointing from the layers panel with the wf layer to the points in the workspace](https://github.com/taylorhixson/WF/blob/master/imagesDOC/added.png?raw=true "Layers added")
...
2. Search for **reproject**, and double click **Reproject layer** under Vector general.
    ...
    ![Image is a screenshot highglighting the Reproject layer tool in the processing toolbox](https://github.com/taylorhixson/WF/blob/master/imagesDOC/reprojectTool.png?raw=true "Reproject layer")
...
3. For the **parameters** in the window that appears:
  ...
  - In the Navigator window, change the output file type to **.geojson**, give it a name, and choose the **Git repository** for this project as the **file directory path** to save the output.
    ...
    ![Image is a screenshot showing how the parameters are input](https://github.com/taylorhixson/WF/blob/master/imagesDOC/reprojectWindow.png?raw=true "How the parameters should look")
...
6. **Remove all layers** from the Layers panel by right clicking the layer and choosing Remove Layer, highlighting layers and clicking the Remove icon in the Layers panel, **OR** pressing `command + D` on the keyboard.
  ...
  ![Image is a screenshot showing the remove layer icon in the layers panel](https://github.com/taylorhixson/WF/blob/master/imagesDOC/remove.png?raw=true "Remove all the old layers")
...
7. Add the reprojected layer by dragging it into the Layers panel. The layer **should** be in the git repository--if it is not, move it there before placing in the layers panel. This is the only item that should appear in the Layers panel! Additionally, make sure you can see the points in the QGIS workspace area.
  ...
  ![Image is a screenshot showing the points appearing in the workspace](https://github.com/taylorhixson/WF/blob/master/imagesDOC/points.png?raw=true "Places should appear in the workspace")
...
9. Double check the project CRS by looking in the bottom right of QGIS. It should show EPSG:3857. If it does not click whatever EPSG code is there, and search for 3857 in the pop up, select it, and click OK.
  ...
  ![Image is a screenshot showing the current project projection of EPSG 3857](https://github.com/taylorhixson/WF/blob/master/imagesDOC/projCRS.png?raw=true "Project CRS")

10. From the top-level toolbar, click Web > QuickMapServices > OpenStreetMap > OSMStandard.

  ![Image is a screenshot showing the location of the basemap options](https://github.com/taylorhixson/WF/blob/master/imagesDOC/basemap.png?raw=true "OpenStreetMap Basemap")

11. Do the places look correct on top of the OpenStreetMap basemap?

  ![Image is a screenshot showing the places on top of the OSM basemap](https://github.com/taylorhixson/WF/blob/master/imagesDOC/pointsTest.png?raw=true "Layers")
...
2. Right click the layer in the Layers panel, and choose open attribute table.
    ...
    ![Image is a screenshot showing the location to open the attribute table](https://github.com/taylorhixson/WF/blob/master/imagesDOC/attributeTable.png?raw=true "Open the Attribute Table")

3. To edit the attribute table, click the pencil icon in the top left of the attribute table or use Command + E (Mac).

    ![Image is a screenshot showing the location to start editing](https://github.com/taylorhixson/WF/blob/master/imagesDOC/edit.png?raw=true "Edit the Attribute Table")
...
**Note**: Deleting a column is permanent. You may want to copy the geojson if this is your first time just in case.
  ...
  ![Image is a screenshot showing the location to delete attributes option](https://github.com/taylorhixson/WF/blob/master/imagesDOC/delete.png?raw=true "Delete empty attributes")
...
5. In the window that appears, click the following columns to select the Latitude and Longitude columns in order to delete them.
      ...
      ![Image is a screenshot showing the columns to delete](https://github.com/taylorhixson/WF/blob/master/imagesDOC/deleteFields.png?raw=true "Select columns to delete")
...
7. If the correct columns were deleted, click the floppy disc icon in the top left to save edits, or press `Ctrl + S` on the keyboard.
    ...
    ![Image is a screenshot showing the columns to delete](https://github.com/taylorhixson/WF/blob/master/imagesDOC/saveEdits.png?raw=true "Save edits")
...
1. From the top toolbar in QGIS, click **Web>qgis2web>Create web map**.
  ...
  ![Image is a screenshot showing the create web map menu](https://github.com/taylorhixson/WF/blob/master/imagesDOC/createWebMap.png?raw=true "Create web map")

2. In the bottom left of the window that appears, click the radio button for **Leaflet**, and if needed, click **Update preview**.

  ![Image is a screenshot showing the Leaflet option and Update preview button](https://github.com/taylorhixson/WF/blob/master/imagesDOC/updatePreview.png?raw=true "update the map preview")
...
3. Make sure the map appears in the right side of the Export to web map window. If nothing appears or only one layer appears, there are two simple possibilities: 1) Leaflet is not selected or 2) the projection is probably incorrect--return to the Create Projected GeoJSON section.
  ...
  ![Image is a screenshot showing the map preview](https://github.com/taylorhixson/WF/blob/master/imagesDOC/mapPreview.png?raw=true "View the map preview")
...
4. Under **Layers and Groups**, change the **Popup fields dropdowns**. I prefer to use **header label**, but the other options are inline label and None. **None** means the field **will appear** but without a label.
  ...
  ![Image is a screenshot showing the popup fields as header labels](https://github.com/taylorhixson/WF/blob/master/imagesDOC/labels.png?raw=true "Update popup labels")
...
5. Click the **Appearance tab**, from the **Add layers list** dropdown choose one of the options. Choosing **collapsed** or **expanded** will **add a legend** to the map.
  ...
  ![Image is a screenshot highlighting the Add layers list option](https://github.com/taylorhixson/WF/blob/master/imagesDOC/legend.png?raw=true "Add a legend")
...
8. Under Data export and to the right of Exporter, click the **three dots at the end of the line** to make sure the **output** goes to the **git repository folder**.
  ...
  ![Image is a screenshot highlighting the three dots to choose where the export goes](https://github.com/taylorhixson/WF/blob/master/imagesDOC/export.png?raw=true "Choose export location of output")
...
10. In the Export to web map window in QGIS, click **Export** at the bottom of the window.
  ...
  ![Image is a screenshot highlighting where the Export button is](https://github.com/taylorhixson/WF/blob/master/imagesDOC/exportClick.png?raw=true "Export to Leaflet")
...
4. Keeping the map in the browser open, now, **right click the index.html file** and choose **Open with...** and select **Atom.app**.
  ...
  ![Image is a screenshot demonstrating how to open the file with Atom](https://github.com/taylorhixson/WF/blob/master/imagesDOC/openAtom.png?raw=true "Open the html file with Atom")
...
5. Within the head tags (`<head>`), delete line 6, or the line which begins `meta name="viewport"...`.
  ...
  ![Image is a screenshot demonstrating how to open the file with Atom](https://github.com/taylorhixson/WF/blob/master/imagesDOC/delete6.png?raw=true "Open the html file with Atom")
...
```
  ...
  ![Image is a screenshot showing the extra mobile tags pasted into hte head](https://github.com/taylorhixson/WF/blob/master/imagesDOC/mobileTags.png?raw=true "How mobile tags look")
...
```
  ![Image is a screenshot showing where to paste the customized popup code in line 23 after the closed curly bracket](https://github.com/taylorhixson/WF/blob/master/imagesDOC/popupCode.png?raw=true "Paste the customized popup code")

8. (Optional) Use command + F to find `marker`.

  ![Image is a screenshot showing where to find the point markers](https://github.com/taylorhixson/WF/blob/master/imagesDOC/marker.png?raw=true "Change the markers")
...
14. Do a find and replace (command + F) for anything else that remains as `layer_OSMStandard_0` and replace it with `googleHybrid`
  ...
  ![Image is a screenshot showing the Atom find and replace window.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/replaceVar.png?raw=true "Replace with googleHybrid")
...
15. **Make your map secure. NOT OPTIONAL**: Open **find and replace** (command + F) to find all instances of **http:** web addresses and replace it with **https:**. Only do this with web addresses and **NOT** any http instances within a variable name or tag). This is necessary so that the final map does not create an insecure connection on websites. If this is not done, the website the map is embedded will appear as insecure.
  ...
  ![Image is a screenshot showing http web address](https://github.com/taylorhixson/WF/blob/master/imagesDOC/http.png?raw=true "Change all http: to https:")

  ![Image is a screenshot showing the change to an https web address](https://github.com/taylorhixson/WF/blob/master/imagesDOC/https.png?raw=true "Change all http: to https:")
...
14. Use command + F to find the line that begins with `L.control.layers`.
  ...
  ![Image is a screenshot showing the Atom find and replace window.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/editLegend.png?raw=true "Replace with googleHybrid")
...
15. Some further changes that can be made:
  ...
  ![Image is a screenshot showing the image path to delete.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/editLegend2.png?raw=true "Edit the legend")


  ![Image is a screenshot showing the image path to delete.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/afterLegend.png?raw=true "Edit the legend")
...
2. From the top left, make sure the current repository is the one with all of the data and Leaflet files.
  ...
  ![Image is a screenshot showing where to find the Current Repository.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/currentRepo2.png?raw=true "Check the current repository")

3. At the bottom, provide at least a summary for the changes and a description if desired, and click **Commit to master**.

  ![Image is a screenshot showing a summary and description.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/commit2.png?raw=true "Commit changes")

4. In the top right, click **Push origin**.

  ![Image is a screenshot showing the Push origin button in Github Desktop.](https://github.com/taylorhixson/WF/blob/master/imagesDOC/push.png?raw=true "Push origin")
<a id="web"></a>
...
Open **Terminal**. If you are not sure where Terminal is, type Terminal into Mac's spotlight.
  ...
  ![Image is a screenshot of searching for Terminal in Mac's spotlight](https://github.com/taylorhixson/WF/blob/master/imagesDOC/terminal.png?raw=true "Terminal in Spotlight")
...
4. Right click the image, and choose **Copy Image Address**.
  ...
  ![Image is screenshot highlighting the Copy Image Address selection when an image is right-clicked in a GitHub online repository](https://github.com/taylorhixson/WF/blob/master/imagesDOC/copyPath.png?raw=true "Copy image path")
...
6. Paste the image link into an empty column in the appropriate row where the image depicts the place listed and described. If using a new spreadsheet, place it  **A1**.
  ...
  ![Image is a screenshot of an image address pasted into the A1 cell of Google Sheets](https://github.com/taylorhixson/WF/blob/master/imagesDOC/pathSheets.png?raw=true "Paste file path")
...
8. In an empty cell in the rows with images, **create alt text** to be read by screen readers or to display when the image does not appear. Alt text should be descriptive of the image **not** the experience.
  ...
  ![Image is screenshot showing an image link in column a column titled Thumbnail and alternative text in column a column titled AltText](https://github.com/taylorhixson/WF/blob/master/imagesDOC/altText.png?raw=true "Create alt text column")
...
13. Use **find and replace** to replace the **+**, or special character used, as a placeholder with a quotation mark.
  ...
  ![Image is a screenshot of using Find and Replace to find plus signs and replace them with quotation marks](https://github.com/taylorhixson/WF/blob/master/imagesDOC/findReplace.png?raw=true "Use Find and Replace for special characters")

  ![Image is a screenshot highlighting how the find and replace works in the spreadsheet to replace all plus signs with quotation marks](https://github.com/taylorhixson/WF/blob/master/imagesDOC/findReplaceComplete.png?raw=true "Quotations should replace plus sign or special characters")
